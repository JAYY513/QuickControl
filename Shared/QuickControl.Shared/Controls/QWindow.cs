...
public class QWindow : Window
{
    ...
    /// </summary>
    protected HwndSource HwndSource => _hwndSource ??= HwndSource.FromHwnd(InteropHelper.Handle);
    ...
    public static readonly DependencyProperty ExtendsContentIntoTitleBarProperty = DependencyProperty.Register(
        ...
        typeof(bool), typeof(QWindow), new PropertyMetadata(false, OnExtendsContentIntoTitleBarChanged));
    ...
    public static readonly DependencyProperty WindowCornerPreferenceProperty = DependencyProperty.Register(
        ...
        typeof(WindowCornerPreference), typeof(QWindow),
    ...
    public QWindow()
    {
        SetResourceReference(StyleProperty, typeof(QWindow));
    }
    ...
    static QWindow()
    {
        ...
        HeightProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(600d));
        WidthProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(1100d));
        MinHeightProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(320d));
        MinWidthProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(460d));
        //WindowStyleProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(WindowStyle.SingleBorderWindow));
        //AllowsTransparencyProperty.OverrideMetadata(typeof(QWindow), new FrameworkPropertyMetadata(false));
    }
    ...
    //    typeof(BackgroundType), typeof(QWindow), new PropertyMetadata(BackgroundType.None, OnBackdropTypeChanged));
