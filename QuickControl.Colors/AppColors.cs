    ...
    public class AppColors : ResourceDictionary
    {
        ...
        public PrimaryColors PrimaryColors
        {
            ...
            set
            {
                ...
                {
                    Source = new Uri(
                        $@"pack://application:,,,/QuickControl.Colors;component/Themes/Recommended/Primary/AgileDesignColor.{value}.xaml")
                };
        ...
        public Theme Theme
        {
            ...
            set
            {
                ...
                {
                    Source = new Uri($@"pack://application:,,,/QuickControl.Colors;component/Themes/Recommended/State/AgileDesignTheme.{value}.xaml")
                };
